return {
  {
    ...
    keys = {
      ...
      { "ga-", "<cmd>lua require('textcase').current_word('to_dash_case')<CR>"      , desc = "Convert to-kebab-case" },
      ...
      { "ga_", "<cmd>lua require('textcase').current_word('to_snake_case')<CR>"     , desc = "Convert to_snake_case" },
      ...
      { "gA-", "<cmd>lua require('textcase').lsp_rename('to_dash_case')<CR>"        , desc = "Refactor with LSP to-kebab-case" },
      ...
      { "gA_", "<cmd>lua require('textcase').lsp_rename('to_snake_case')<CR>"       , desc = "Refactor with LSP to_snake_case" },
      ...
      { "gz-", "<cmd>lua require('textcase').operator('to_dash_case')<CR>"          , desc = "Convert with operator to-kebab-case" },
      ...
      { "gz_", "<cmd>lua require('textcase').operator('to_snake_case')<CR>"         , desc = "Convert with operator to_snake_case" },
